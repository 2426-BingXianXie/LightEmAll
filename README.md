...
- ✅ **Graph Theory** - MST generation, BFS traversal
- ✅ **Data Structures** - Union-Find with path compression
- ✅ **Optimization** - O(1) neighbor lookups, efficient BFS

### Object-Oriented Programming
- ✅ **Inheritance** - World subclass, interface implementations
- ✅ **Encapsulation** - Private fields, public interfaces
- ✅ **Polymorphism** - GamePiece rendering, event handling

### Software Engineering
- ✅ **Design Patterns** - MVC architecture, Factory pattern
- ✅ **Testing** - Comprehensive unit tests, edge case coverage
- ✅ **Documentation** - Javadoc-style comments, clear naming

### Game Development
- ✅ **Interactive Graphics** - Dynamic rendering, visual feedback
- ✅ **User Experience** - Intuitive controls, score tracking
- ✅ **Game Loop** - Tick-based updates, event-driven design

### Problem Solving
- ✅ **Algorithm Selection** - Choosing appropriate algorithms for tasks
- ✅ **Complexity Analysis** - Understanding time/space tradeoffs
- ✅ **Debugging** - Systematic testing, edge case handling
...
│  🟡 Fully powered nodes (yellow)     │
│  🟠 Distant powered nodes (orange)   │
│  ⚪ Unpowered nodes (gray)           │
│                                      │
│  Score: 42  |  Time: 2:15           │
└─────────────────────────────────────┘
```
...
This project was completed as part of CS2510 Fundamentals of Computer Science II at Northeastern University. The code demonstrates concepts learned in the course including:
...
**Academic Use**: This project is for educational purposes and portfolio demonstration.

**Code Usage**: Due to academic integrity policies, this code should not be copied for coursework submissions. However, it may be referenced for learning purposes with proper attribution.
...
### BingXian (Eason) Xie
- 📧 **Email**: xie.bingx@northeastern.edu
- 💼 **LinkedIn**: [linkedin.com/in/bingxian-xie](https://www.linkedin.com/in/bingxian-xie)
- 💻 **GitHub**: [@2426-BingXianXie](https://github.com/2426-BingXianXie)
- 📱 **Phone**: (857) 272-9958
...
© 2025 BingXian Xie. All rights reserved.

This project is submitted as academic coursework for Northeastern University CS2510. Code may be used for educational reference with proper attribution.
...
**Built with ☕ Java and 🎮 passion for game development**

[⬆ Back to Top](#light-em-all---electrical-circuit-puzzle-game)
